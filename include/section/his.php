<section class="moreinfo-tovar__history">
	<a href="#" class="_title">
		Вы недавно смотрели
	</a>
	<div class="product-block-slids">
		<div class="swiper-wrapper">
			...
			<div class="swiper-slide">
				<div class="product__block product-block">
							...
							<div class="product-block-image__items">
								<?php
									...
									if ($allProductsImagesLength > 1) {
										...
										echo '<div class="product-block-image__item product-block-image-item">
												<div class="product-block-image-item__img">
													<img src="img/shortcuticons/icon.png" alt="img">
												</div>
												</div>';
									}
								?>
					...
					<div class="product-block__info product-block-info">
						<a href="category.php" class="product-block-info__catigory">
							Категория><?php echo $allProduct["category"]; ?>
						</a>
			...
			?>
			<div class="swiper-slide">
				<div class="product-block-slids__historyinnerlink">
					<a href="#" class="product-block-slids__historylink product-block-slids-historylink">
